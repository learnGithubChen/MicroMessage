...
<head>
    ...
    <script src="../../../js/back/list.js"></script>
</head>
<body style="background: #e1e9eb;">
<form action="/list" id="mainForm" method="post">
    <div class="right">
        ...
        <div class="rightCont">
            ...
            <div class="zixun fix">
                <table class="tab2" width="100%">
                    ...
                    <c:forEach items="${messageList}" var="message1" varStatus="status">

                        <tr <c:if test="${status.index%2!=0}">style = 'background-color:#ECF6EE;'</c:if>>
                            <td><input type="checkbox" name="id" value="${message1.id}"/></td>
                            <td>${status.index+1}</td>
                            <td>${message1.command}</td>
                            <td>${message1.description}</td>
                            <td>
                                <a href="#">修改</a>&nbsp;&nbsp;&nbsp;
                                <a href="/deleteSingle?ID=${message1.id}">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
