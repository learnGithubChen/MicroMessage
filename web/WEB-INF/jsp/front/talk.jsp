...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript" src="../../../js/common/jquery.jscrollpane.min.js"></script>
	<script type="text/javascript" src="../../../js/common/scroll-startstop.events.jquery.js"></script>
	<!--讨论区滚动条end-->
	<script type="text/javascript" src="../../../js/front/talk.js"></script>
	</head>
	<body>
		...
		<div class="talk">
			...
			<div class="talk_word">
				...
				<input id="content" class="message1s emotion"   />
